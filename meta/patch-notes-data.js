...
const PATCH_NOTES = [
  { v:'V427', d:'25/07/2026 09:00', name:{fr:'Soldat de Bashim (Base de Bashim) : nouvelle silhouette dédiée, ne montre plus un loup', en:'Bashim Soldier (Bashim Base): new dedicated silhouette, no longer shows a wolf'}, fr:[
